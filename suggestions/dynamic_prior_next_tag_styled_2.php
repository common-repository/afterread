...
if ($afterRead_previous_post) {
	$afterRead_previous_post_link = '<a href="'.$afterRead_previous_post->guid.'" rel="prev">&laquo; '.$afterRead_previous_post->post_title.'</a>';
}
if ($afterRead_next_post) {
	$afterRead_next_post_link = ' <a href="'.$afterRead_next_post->guid.'" rel="next">'.$afterRead_next_post->post_title.' &raquo;</a>';
}
$afterRead_sugestion = '<div style="display:block;"><p><div style="float:left;">'.$afterRead_previous_post_link.'</div><div style="float:right;">'.$afterRead_next_post_link.'</div></p></div><div style="clear:both"></div>';
