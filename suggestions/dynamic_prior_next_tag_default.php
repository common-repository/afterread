...
if ($afterRead_previous_post) {
	$afterRead_previous_post_link = '&laquo; <a href="'.$afterRead_previous_post->guid.'" rel="prev">'.$afterRead_previous_post->post_title.'</a>';
}
if ($afterRead_next_post) {
	$afterRead_next_post_link = ' <a href="'.$afterRead_next_post->guid.'" rel="next">'.$afterRead_next_post->post_title.'</a> &raquo;';
}
