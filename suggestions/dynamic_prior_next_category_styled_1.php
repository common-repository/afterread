...
ob_start();
previous_post_link('%link','<div>&laquo Previous Entry <br /> <div style="font-size:0.4em; float:right;">%title</div></div>', True );
$afterRead_dynamic_previous_contents = ob_get_clean();
//And again...
ob_start();
next_post_link('%link','<div>Next Entry &raquo<br /> <div style="font-size:0.4em; float:left;">%title</div></div>', True );
